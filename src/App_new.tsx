...
import { BarChart, BubbleChart } from "./BubuleChart";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-9 mt-2 xl:border rounded-md dark:border-neutral-800">
            <div key="f1" className="col-span-1 lg:col-span-5 ">
              ...
              <FeatureCard className="border-b lg:border-r dark:border-neutral-800">
                ...
                <FeatureDescription>
                  ...
                  performance improved by 10.4%, 13.5%, and 13.5% for the three
                  tasks, respectively.
                </FeatureDescription>
                <div className=" h-full w-full">
                  <img
            ...
            >
              ...
              <FeatureDescription>
                ...
                0.1-1B, 1-2B, and 2-3B) is relatively similar and aligns with
                the latency increase as the model size grows.For models of
                similar size from different architectures, the first token time
                during the prefill stage vary significantly.However, the model’s
                latency during the decode stage more closely follows a linear
            ...
            >
              <FeatureTitle> Architecture and Datasets over time</FeatureTitle>
              <FeatureDescription>
                While we focus on only decoder-only transformer SLMs, their
                specific configurations still diversify.but we can conclude some
                common trends.
                <li> MHA is gradually being phased out and replaced by GQA.</li>
                <li>
                ...
                <li>
                  We also investigate how the open-sourced pre-training datasets
                  are used in training the SLMs,and you can see how they change
                  over time.
                </li>
              </FeatureDescription>
              <div className=" h-full w-full   align-middle ">
